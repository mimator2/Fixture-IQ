#!/usr/bin/env python3
"""
Run football_data_pipeline.py for multiple teams in parallel
"""
...
# Define teams with their URLs and squad IDs
TEAMS = {
    "Manchester-City": {
        "url": "https://fbref.com/en/squads/b8fd03ef/2024-2025/all_comps/Manchester-City-Stats-All-Competitions",
        "season": "2024-2025"
    },
    "Arsenal": {
    ...
    "Liverpool": {
        "url": "https://fbref.com/en/squads/822bd0ba/2024-2025/all_comps/Liverpool-Stats-All-Competitions",
        "season": "2024-2025"
    },
    "Aston-Villa": {
...
def main():
    ...
    print("\n" + "="*70)
    print("FOOTBALL DATA PIPELINE - MULTI-TEAM EXTRACTION")
    print("="*70)
